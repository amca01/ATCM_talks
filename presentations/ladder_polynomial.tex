...
\newpage
\begin{dmath*}
(a^4 b^4 w^2 - 2 a^2 b^2 w^6 + w^{10}) x^{12} + (-4 a^4 b^3 w^3 h -
...
- 4 a^4 b^4 w^4 + 6 a^4 b^2 w^6 + 6 a^2 b^4 w^6 + 4 a^2 b^2 w^8 - 4 a^2 w^{10}
- 4 b^2 w^{10} + 4 a^4 b^4 w^2 h^2 + 4 a^4 b^2 w^4 h^2 - 8 a^3 b^3 w^4 h^2 +
...
(8 a^6 b^3 w^3 h + 4 a^5 b^4 w^3 h + 4 a^4 b^5 w^3 h + 8 a^3 b^6 w^3 h -
...
12 a^3 w^9 h + 12 b^3 w^9 h + 8 a w^{11} h + 8 b w^{11} h) x^9 + (a^8 b^4 w^2 +
4 a^6 b^6 w^2 + a^4 b^8 w^2 + 8 a^6 b^4 w^4 + 8 a^4 b^6 w^4 - 6 a^6 b^2 w^6 -
...
4 a^8 b w^7 h - 32 a^6 b^3 w^7 h - 16 a^5 b^4 w^7 h - 16 a^4 b^5 w^7 h -
...
96 a^5 b^5 w^6 h^2 - 16 a^4 b^6 w^6 h^2 + 36 a^3 b^7 w^6 h^2 -
...
36 a^2 b^6 w^8 h^2 + 8 a b^7 w^8 h^2 + 2 b^8 w^8 h^2 + 6 a^6 w^{10} h^2 -
